...
class Attention(nn.Module):
    ...
    def forward(
        ...
        xk = xk.view(bsz, seqlen, self.n_local_kv_heads, 1, self.head_dim).repeat(1, 1, 1, self.n_local_heads//self.n_local_kv_heads, 1).view(bsz, seqlen, self.n_local_heads, self.head_dim)
        xv = xv.view(bsz, seqlen, self.n_local_kv_heads, 1, self.head_dim).repeat(1, 1, 1, self.n_local_heads//self.n_local_kv_heads, 1).view(bsz, seqlen, self.n_local_heads, self.head_dim)
